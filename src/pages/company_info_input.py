        ...
        [
            ...
            dbc.Row(
                [
                    dbc.Col(
                        html.H2(
                            "Company Info Input Page", id="app-title", className="my-4"
                        ),
                        width=12,
                        lg=6,
                        className="mx-auto",
                    ...
                    dbc.Col(
                        [
                            ...
                            dbc.Checklist(
                                ...
                                options=[
                                    {
                                        "label": "Available for getting position information",
                                        "value": "available",
                                    }
                                ],
                                value=[],
                                ...
                                children=[
                                    ...
                                    dcc.Dropdown(
                                        ...
                                        options=[
                                            ...
                                            {
                                                "label": "static_response",
                                                "value": "static_response",
                                            },
                                            {
                                                "label": "dynamic_website",
...
def register_callbacks(app):
    @app.callback(
        Output("available-section", "style"), [Input("available-checkbox", "value")]
    )
    ...
    @app.callback(
        Output("is-local-section", "style"), [Input("is-local-checkbox", "value")]
    )
    ...
    def submit_form(
        ...
        try:
            location_list = (
                [float(coord.strip()) for coord in company_location.split(",")]
                if company_location
                else None
            )
        except ValueError:
